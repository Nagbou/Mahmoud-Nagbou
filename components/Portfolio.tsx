  ...
  const secondCarouselItems = [
    {
      ...
      modalDetails: {
        text: "I designed and developed a full-stack web application for a real estate agency using the MERN stack (MongoDB, Express.js, React, and Node.js) with Tailwind CSS for a sleek, responsive, and modern user interface. This project features a well-structured landing page that captivates visitors, an 'About' page detailing the agency’s background, and a 'Contact' page for smooth client communication.To ensure a seamless user experience, I utilized Tailwind CSS, enabling quick and consistent styling across all components. This approach ensures responsive design across devices, enhancing usability and maintaining visual consistency. The platform includes a categorized property section, allowing users to browse through different property types and access detailed property pages with comprehensive listing information.The application also features secure authentication, allowing users to create accounts, log in, save their favorite listings, and manage profiles. This system, backed by MongoDB for efficient data storage and managed with Express.js and Node.js, ensures secure and reliable user data handling. The front end, built with React, provides smooth navigation, dynamic content rendering, and responsive interactivity.This project combines modern web technologies to create a feature-rich and user-centric experience, supporting the agency in client acquisition and engagement. The MERN stack offers scalability, and the use of Tailwind CSS provides a visually appealing, efficient design workflow, aligning with the agency’s goals to provide top-tier service and build client relationships.",
