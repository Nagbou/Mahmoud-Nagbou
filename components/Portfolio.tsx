...
export const Portfolio: React.FC = () => {
  const firstCarouselItems = [
    {
      title: " Metrics to Meaning: An AI-Driven BI Platform for Insightful Visualization, Behavioral Interpretation, and Personalized Coaching",
      text: "Many users find it challenging to interpret the complex data generated by virtual collaboration platforms, making it hard to transform insights into meaningful action. To tackle this, I created a smart widget that not only visualizes key performance indicators and trends but also uses AI to interpret these patterns in plain language. This widget then provides personalized coaching tips and actionable recommendations, helping users bridge the gap between raw data and clear, data-driven decisions to enhance their performance and collaboration.",
      imgSrc: "/imgs/el-cover.jpg",
      moreDetailsLink: "#",
      visitLink: "https://elokencia-app-1.onrender.com/",
      modalDetails: {
        text: " In today’s digital landscape, collaboration platforms like Microsoft Teams and Zoom generate vast amounts of data, yet many users struggle to make sense of it. I noticed that while data dashboards exist, they often leave users without clear guidance or actionable insights. As a response, I designed and developed an intelligent widget that goes beyond static visualizations. My solution leverages AI to analyze user performance in real time, visualize key performance indicators, and provide personalized coaching tips to help individuals and teams improve their virtual meeting communication and productivity. \nFor this project, I implemented machine learning models in Python using TensorFlow, Scikit-learn, and integrated LLMs to interpret and explain visualized data in natural language. I built an interactive frontend in React to display real-time feedback and dashboards, while FastAPI served as the backend for efficient data processing and integration. To create engaging and clear visualizations, I used Matplotlib and Plotly. Finally, I deployed the entire application on Render to ensure it was accessible, scalable, and reliable. This personal project allowed me to merge my skills in business intelligence, web development, and AI, resulting in an innovative tool that bridges the gap between raw data and practical, user-centered insights.",
        images: [
          "/imgs/el- (21).png","/imgs/el- (8).png","/imgs/el- (2).png","/imgs/el- (28).png","/imgs/el- (9).png","/imgs/el- (1).png","/imgs/el- (31).png","/imgs/el- (7).png","/imgs/el- (23).png","/imgs/el- (11).png"
        ],
      },
    },
    {
