...
export const Portfolio: React.FC = () => {
  const firstCarouselItems = [
    ...
    },
    {
      ...
      modalDetails: {
        text: "Understanding Emotions: A Data-Driven Sentiment Analysis of Social Media delves into the intricate relationship between emotions and user engagement across popular social media platforms. Implemented using React.js and enriched with Power BI for interactive data visualization, this web application utilizes advanced analytical techniques to examine a comprehensive dataset, identifying trends in sentiments expressed through likes, retweets, and hashtags.We focus on the most engaging sentiments, such as joy, excitement, and positivity, while also considering the growing impact of emotions like confusion and curiosity. Through geographical, platform-specific, and temporal analyses, we uncover regional variations in emotional expression and highlight the dominance of positive sentiments in user interactions.This project aims to provide a deeper understanding of how sentiments influence social media dynamics and user behavior, offering valuable insights for businesses and researchers looking to navigate the evolving emotional landscape of the digital world. The combination of React.js for the application and Power BI for data visualization ensures an engaging and informative user experience.",
        images: ["/imgs/ssa-1.jpg", "/imgs/ssa-2.jpg", "/imgs/ssa-3.jpg", "/imgs/ssa-4.jpg", "/imgs/ssa-5.jpg", "/imgs/ssa (1).jpg", "/imgs/ssa (2).jpg", "/imgs/ssa (3).jpg", "/imgs/ssa (4).jpg", "/imgs/ssa (5).jpg", "/imgs/ssa (6).jpg", "/imgs/ssa (7).jpg", "/imgs/ssa (8).jpg"], // Additional images
      },
    },
  ];
